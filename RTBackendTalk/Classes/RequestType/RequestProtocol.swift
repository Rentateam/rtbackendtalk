...
extension Encodable {
  func asParameters() throws -> Parameters {
    ...
    guard let dictionary = try JSONSerialization.jsonObject(with: data, options: .allowFragments) as? [String: Any] else {
        throw RTBackendTalkError.encodableToDictionary("Failed to convert Encodable to Parameters ([String: Any])")
    }
    return dictionary
  }
}

enum RTBackendTalkError: Error {
    case encodableToDictionary(String)
}
